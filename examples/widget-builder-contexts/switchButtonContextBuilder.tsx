...
export class SwitchButtonContextBuilder {
    ...
    build() {
        ...
        const syncLocationWithState = (switchButtonState: ISwitchButtonState, history: History) => {
            ...
            enabledUrlParam && (pathname[enabledUrlParam] = enabledState && encodeURIComponent(JSON.stringify(enabledState)));
        ...
        const Component = (props: IComponentProps) => {
            ...
            React.useEffect(() => {
                if (didMount.current) {
                    syncLocationWithState(switchButtonState, history);
                } else {
                    didMount.current = true;
                }
            }, [switchButtonState, history]);
