// Generated by cra-context-generator@1.0.0 on Sun, 15 May 2022 11:02:56 GMT.
...
export class SwitchButtonContextBuilder {
    ...
    build() {
        ...
        const syncStateWithLocation = (switchButtonState: ISwitchButtonState, location: Location<any>) => {
            ...
            const enabled = enabledUrlParam && pathname[enabledUrlParam] && decodeURIComponent(pathname[enabledUrlParam]);
